...
- [Toshy](https://github.com/RedBearAK/Toshy), a desktop key remapper for Linux that makes shortcuts behave like macOS. Available as [services.toshy](#opt-services.toshy.enable).
